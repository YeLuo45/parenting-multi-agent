...
- 儿科医生：疾病分诊、疫苗、用药剂量建议
- 心理师：情绪、行为、压力、依恋
- 教育顾问：学习、学校、兴趣、能力追踪，**学科级学习教练（9 学科 × 6 阶段）**
- 营养师：辅食、过敏、食谱、挑食
- 睡眠教练：作息、夜醒、睡眠倒退
- 家庭调解员：家庭冲突与沟通
- 财务顾问：育儿预算、教育储蓄
- 父母支持：照护者压力与 burnout
- 成长追踪：身高、体重、百分位、里程碑，**按领域查询里程碑（5 领域 × 0-72 月）、下一里程碑预测、漏检清单、ASCII 生长曲线图 + 百分位波动检测**
- 习惯教练：日程、屏幕时间、睡前流程、习惯循环、**家庭连续打卡 + 排行榜、12 个成就徽章（连续打卡、完美周、复出、稳定输出）**
- 知识 RAG：循证育儿 FAQ、LLM Provider 链（3 层降级）、媒体参考（视频/音频/文章 8 项）、TTS 语音播报队列
- 安全守护：风险预防、急救、紧急升级
- 社交顾问：分享、友谊、玩伴、同伴压力
- 入学准备：幼小衔接和小学适应
- 升学规划：申请、长期规划、准备度
