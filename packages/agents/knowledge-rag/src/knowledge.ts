...
export const KNOWLEDGE_BASE: KnowledgeEntry[] = [
	...
	},
	{
		...
		question: "宝宝背带有什么好处？",
		answer:
			"许多文化使用背带/包裹背宝宝，这种做法可促进亲子依恋、便于哺乳、解放父母双手。具体时长和姿势因文化而异。",
		evidence: "anecdotal",
		references: [
			{
				org: "UNICEF",
	...
	// ─── Nutrition: solids, allergies, picky eating ─────────────────
	{
		...
		answer:
			"WHO 和 AAP 推荐纯母乳或配方奶至 6 月龄左右，6 个月左右引入辅食，过早（<4 个月）增加过敏和窒息风险，过晚（>7 个月）可能错过味觉敏感期。",
		evidence: "systematic_review",
		references: [
	...
	},
	{
		...
		answer:
			"LEAP 研究（2015）等多项证据显示，4-6 月龄起在医生指导下早期引入花生和鸡蛋可显著降低食物过敏风险。无需刻意推迟。",
		evidence: "rct",
		references: [
			{
				org: "AAP",
	...
	},
	{
		...
		answer:
			"1 岁后可以喝全脂牛奶（每日不超过 720ml），同时保持均衡饮食。2 岁后根据饮食和体重可考虑低脂奶。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		question: "宝宝可以喝果汁吗？",
		answer:
			"AAP 建议 1 岁以下不喝任何果汁，1-3 岁每天不超过 120ml，4-6 岁不超过 180ml。直接吃水果更优，果汁含糖高且缺少纤维。",
		evidence: "expert_opinion",
		references: [
			{ org: "AAP", title: "Fruit Juice in Infants, Children, and Adolescents", year: 2023 },
		],
	},
	{
		...
		question: "孩子挑食怎么办？",
		answer:
			"挑食在 2-5 岁常见。研究支持\"反复暴露\"（同一食物出现 10-15 次）+ \"角色榜样\"（家长一起吃）+ \"健康压力\"（一餐固定时间，30 分钟）三策略。避免强迫或贿赂。",
		evidence: "cohort",
		references: [
			{
				org: "AAP",
	...
	},
	{
		...
		question: "幼儿缺铁性贫血怎么办？",
		answer:
			"6-24 月龄是缺铁高发期。建议：① 4-6 月起高铁辅食（强化铁米粉、红肉泥）；② 维生素 C 助铁吸收；③ 1 岁后筛查血红蛋白；④ 必要时补充铁剂。",
		evidence: "systematic_review",
		references: [
			{ org: "AAP", title: "Iron Deficiency in Early Childhood", year: 2022 },
		],
	},
	// ─── Sleep: night wakings, training, naps ──────────────────────
	{
		...
		answer:
			"1 岁后夜醒 1-2 次仍属正常（睡眠周期转换时易醒）。建议：① 固定睡前流程；② 自我安抚（不依赖喂奶/抱）；③ 检查环境（温度、湿度、噪音）；④ 持续 2 周以上且影响发育需就医。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		answer:
			"4-6 月龄后可以开始渐进式睡眠训练（如 Ferber 法、椅子法）。研究显示渐进式哭泣时间（5-30 分钟）不会对亲子依恋或压力水平造成长期影响。",
		evidence: "rct",
		references: [
			{
				org: "AAP",
	...
	},
	{
		...
		question: "孩子白天要睡几次？",
		answer:
			"推荐：4-12 月龄 2-3 次小睡；12-18 月龄过渡到 2 次；18 月-3 岁 1 次；3-5 岁部分孩子可以完全不需要。睡眠总时长 0-3 岁建议 11-14 小时/天（含夜睡+小睡）。",
		evidence: "expert_opinion",
		references: [
			{ org: "AAP", title: "Recommended Sleep Duration by Age", year: 2023 },
		],
	},
	{
		...
		question: "可以和宝宝同床睡吗？",
		answer:
			"AAP 建议 1 岁前同房不同床。同床睡增加婴儿猝死综合征 (SIDS)、窒息、跌落风险。如选择同床须排除：父母吸烟/饮酒/服药、软床垫、过多被褥、早产或低体重儿。",
		evidence: "systematic_review",
		references: [
	...
	},
	{
		...
		answer:
			"噩梦发生在 REM 睡眠期（后半夜），孩子会醒来并记得内容，需要安慰。夜惊发生在 NREM 深睡期（上半夜），孩子看起来惊恐但实际未醒，次日无记忆，强行唤醒会延长发作。",
		evidence: "expert_opinion",
		references: [
	...
	// ─── Health: fever, medication, illness ─────────────────────────
	{
		...
		answer:
			"3 月龄以上可用对乙酰氨基酚（泰诺林），6 月龄以上可用布洛芬（美林）。按体重给药，不按年龄。每 4-6 小时一次，24 小时不超过 4 次。3 月龄以下发烧立即就医。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		answer:
			"3 月龄以下任何发烧立即就医；3-36 月龄发烧 ≥38°C 持续 24 小时以上或精神差需就医；任何年龄 ≥40°C、惊厥、呼吸困难、皮疹、拒绝喝水立即就医。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		answer:
			"4 岁以下不推荐任何非处方止咳药或感冒药（副作用大于收益）。1 岁以上可以喝蜂蜜（半勺-1 勺）缓解夜咳，效果相当于右美沙芬。4-6 岁需医生指导。",
		evidence: "rct",
		references: [
			{ org: "AAP", title: "Cough and Cold Medicine in Children", year: 2022 },
		],
	},
	{
		id: "kb-diarrhea-ors",
		...
		question: "孩子腹泻怎么办？",
		answer:
			"补液是关键！口服补液盐 (ORS) III 优于白水、果汁或运动饮料。每次稀便后补充：<2 岁 50-100ml，2-10 岁 100-200ml。持续 24 小时以上、精神差、尿少或血便立即就医。",
		evidence: "systematic_review",
		references: [
	...
	},
	{
		...
		question: "感冒需要吃抗生素吗？",
		answer:
			"普通感冒、流感、绝大多数咽喉炎是病毒引起，抗生素无效。滥用抗生素导致耐药菌增加、肠道菌群紊乱、过敏风险上升。医生判断为细菌感染（链球菌、肺炎等）时才用。",
		evidence: "systematic_review",
		references: [
	...
	},
	{
		...
		question: "宝宝湿疹怎么护理？",
		answer:
			"湿疹核心是皮肤屏障缺陷：① 每日 1-2 次厚涂保湿霜（凡士林/丝塔芙/艾维诺）；② 温水短浴（<10 分钟）；③ 避免羊毛/化纤直接接触；④ 中重度需要弱效激素（地奈德）短期使用；⑤ 排查食物过敏（与皮肤科/过敏科）。",
		evidence: "systematic_review",
		references: [
	...
	},
	{
		...
		answer:
			"疫苗后 24 小时内低热（<38.5°C）常见，是免疫反应。处理：多喝水、物理降温、必要时按体重给对乙酰氨基酚。持续高热 >48 小时或精神差需就医排除偶合感染。",
		evidence: "expert_opinion",
		references: [
			{ org: "CDC", title: "Vaccine Side Effects", year: 2023 },
		],
	},
	{
		...
		answer:
			"6 月龄以上推荐每年接种流感疫苗（9 岁以下首次接种需 2 剂，间隔 4 周）。最佳时间为 10 月底前。孕妇接种可保护 <6 月龄不能接种的婴儿。",
		evidence: "systematic_review",
		references: [
	...
	// ─── Behavior & Emotion ────────────────────────────────────────
	{
		...
		answer:
			"1-3 岁发脾气持续 5-15 分钟常见（极端情况 30 分钟）。多数儿童 4 岁后逐渐减少。如果 >30 分钟、每天多次、5 岁后仍频繁且无法安抚，建议看发育行为儿科。",
		evidence: "cohort",
		references: [
			{ org: "AAP", title: "Temper Tantrums", year: 2022 },
		],
	},
	{
		...
		answer:
			"8-18 月龄是分离焦虑高峰期，是健康依恋的表现。处理：① 短暂离开前明确告知\"妈妈去 XX 会回来\"；② 告别仪式简短（避免偷偷溜走）；③ 留下安抚物；④ 接受者（祖父母/老师）多陪伴。",
		evidence: "expert_opinion",
		references: [
			{ org: "AAP", title: "Separation Anxiety", year: 2021 },
		],
	},
	{
		...
		answer:
			"1-3 岁咬人是表达挫折的语言前阶段行为。处理：① 立即平静制止并说\"不可以咬人会痛\"；② 关注被咬孩子；③ 不打骂、不嘲笑；④ 识别触发场景（争抢玩具、过度刺激、表达需求）；⑤ 持续 3 个月以上或 4 岁仍咬人需评估。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		answer:
			"WHO 和 AAP：18 月龄以下避免任何屏幕（视频通话除外）；18-24 月龄家长陪伴看高质量节目 <1 小时；2-5 岁每天屏幕 <1 小时；5 岁以上每天 <2 小时并保持 1 小时户外活动。",
		evidence: "systematic_review",
		references: [
			{ org: "WHO", title: "Guidelines on Physical Activity, Sedentary Behaviour and Sleep for Children Under 5 Years of Age", year: 2019 },
		],
	},
	{
		...
		answer:
			"30-60 分钟固定睡前流程（洗澡→换睡衣→刷牙→讲故事→关灯）可：① 提升睡眠质量 30%+；② 减少夜醒；③ 改善白天情绪和行为；④ 让孩子形成可预测的安全感。",
		evidence: "cohort",
		references: [
			{ org: "AAP", title: "Bedtime Routines for Young Children", year: 2022 },
		],
	},
	// ─── Development milestones ────────────────────────────────────
	{
		...
		question: "宝宝什么时候学会走路？",
		answer:
			"独立行走 9-18 月龄（平均 12 月龄）。如果 18 月龄仍不能独走、2 岁仍步态异常（如明显跛行或足尖步态持续 3 月+），需看发育儿科或儿童骨科排查。",
		evidence: "cohort",
		references: [
			{ org: "AAP", title: "Developmental Milestones: Walking", year: 2023 },
		],
	},
	{
		...
		answer:
			"预警信号：12 月龄不会用手指物/挥手再见；18 月龄不会说 6 个词或听不懂简单指令；2 岁词汇 <50 个或不会 2 词短语；3 岁听不懂故事、陌生人听不懂。任一情况需要听力筛查 + 言语评估。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		answer:
			"9-12 月龄学会拇指-食指对捏（\"钳形抓握\"）。早期练习机会：① 小米花/溶豆（注意窒息风险需软化）；② 串大珠子；③ 按形状分类。如果 12 月龄仍不会用钳形抓握，建议看康复科。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		answer:
			"平均 22-36 月龄。准备信号：① 尿布湿了会示意；② 能听懂简单指令；③ 自己拉下裤子；④ 想模仿大人；⑤ 尿布干燥 2 小时以上。强制训练易导致便秘和对如厕的抗拒。",
		evidence: "cohort",
		references: [
			{ org: "AAP", title: "Toilet Training", year: 2022 },
		],
	},
	// ─── Education & Learning ─────────────────────────────────────
	{
		...
		answer:
			"出生后就可以开始\"亲子共读\"。0-3 岁重点是词汇输入和亲子互动，不是理解。研究显示：5 岁前共读 1000+ 本书的孩子，语言和读写能力显著高于未共读者。",
		evidence: "cohort",
		references: [
	...
	},
	{
		...
		question: "孩子几岁可以上幼儿园？",
		answer:
			"2.5-3 岁可考虑日托或幼儿园小班。准备清单：① 基础自理（自己吃饭、上厕所）；② 简单指令理解；③ 短时分离不焦虑；④ 疫苗接种完成；⑤ 表达基本需求（饿了、困了、想上厕所）。",
		evidence: "expert_opinion",
		references: [
			{ org: "AAP", title: "Starting Preschool", year: 2022 },
		],
	},
	{
		...
		answer:
			"3-6 岁阶段推荐\"游戏式学习\"：自由游戏、角色扮演、户外探索、积木、绘画。读写算术等\"正式学习\"在 6-7 岁大脑准备好后更有效。早期填鸭可能适得其反。",
		evidence: "systematic_review",
		references: [
			{ org: "AAP", title: "The Power of Play", year: 2023 },
		],
	},
	// ─── Safety ─────────────────────────────────────────────────────
	{
		...
		answer:
			"美国儿科学会：① 0-2 岁反向安装（rear-facing）；② 2 岁后或超出座椅上限改正向安装（forward-facing）；③ 身高体重达上限后用 booster；④ 12 岁前或身高 145cm 前不能直接用成人安全带。",
		evidence: "expert_opinion",
		references: [
			{ org: "AAP", title: "Car Seats: Information for Families", year: 2023 },
		],
	},
	{
		...
		answer:
			"4 岁以下高风险食物：整粒坚果、葡萄（应纵切）、爆米花、热狗（应纵切）、硬糖、生胡萝卜（应煮软或切丝）、花生酱（厚涂）。急救法：5 次拍背 + 5 次胸推（<1 岁）或海姆立克（>1 岁）。",
		evidence: "expert_opinion",
		references: [
			{ org: "AAP", title: "Choking Prevention", year: 2023 },
		],
	},
	{
		...
		question: "宝宝多大可以学游泳？",
		answer:
			"AAP 不建议 1 岁前任何游泳课（无证据降低溺水风险）。1-4 岁可参加有安全保障的水中适应课程，但绝不替代看护。家中：① 卫生间门常关；② 浴缸/水桶用完立即排空；③ 泳池 4 面围栏 + 门自锁。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		answer:
			"立即拨打 120（中国）/ 1-800-222-1222（美国 Poison Control）。不要催吐（强酸强碱会二次损伤），不要喝水或牛奶（影响医院判断），带上原包装去医院。如已昏迷或抽搐立即 120。",
		evidence: "expert_opinion",
		references: [
			{ org: "AAP", title: "Poison Prevention", year: 2023 },
		],
	},
	{
		...
		question: "宝宝可以用防晒霜吗？",
		answer:
			"6 月龄以下避免阳光直射，靠物理遮挡（帽子、衣物、推车遮阳棚）。6 月龄以上可使用氧化锌/二氧化钛的物理防晒霜，SPF ≥30。阴天也要防晒。婴儿晒伤 1 次未来皮肤癌风险翻倍。",
		evidence: "systematic_review",
		references: [
			{ org: "AAP", title: "Sun Safety", year: 2023 },
		],
	},
	// ─── Family dynamics ──────────────────────────────────────────
	{
		...
		answer:
			"研究显示父母常感觉偏心但孩子未必感受相同。减少冲突：① 不公开比较；② 各自找每个孩子的\"独特时间\"（15 分钟一对一）；③ 承认每个孩子性格不同；④ 关注努力而非表现。",
		evidence: "cohort",
		references: [
			{ org: "APA", title: "Sibling Favoritism", year: 2021 },
		],
	},
	{
		...
		answer:
			"建议：① 父母先达成一致再沟通（避免当面分歧）；② 区分\"原则问题\"（安全、健康）和\"风格问题\"（穿衣、哄睡方式）；③ 选 1-2 个最重要的\"红线\"（如睡眠姿势、安全座椅）坚持，其他可让步；④ 定期单独沟通，避免在孩子面前争吵。",
		evidence: "expert_opinion",
		references: [
			{ org: "APA", title: "Grandparents Raising Grandchildren", year: 2022 },
		],
	},
	{
		...
		answer:
			"研究显示 5 岁前经历父母离婚的孩子，5-10 年后行为问题风险增加 30-50%，但影响因素复杂（冲突水平、经济、共同抚养质量最关键）。建议：① 不在孩子面前争吵；② 保持日常一致性（上学、吃饭、睡觉）；③ 双方都说对方好话；④ 必要时寻求儿童心理咨询。",
		evidence: "cohort",
		references: [
			{ org: "APA", title: "Children and Divorce", year: 2021 },
		],
	},
	// ─── School readiness & teen issues ───────────────────────────
	{
		...
		answer:
			"5-6 岁入学准备清单：① 自理（穿衣、上厕所、洗手、吃饭）；② 基础社交（轮流、分享、解决冲突）；③ 注意力（能专注 15-20 分钟听故事）；④ 基础认知（数 0-10、认自己名字、听懂 2-3 步指令）；⑤ 情绪调节（能离开父母、面对挫败）。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		question: "孩子几年级开始有作业？",
		answer:
			"研究表明 1-3 年级（6-8 岁）作业对学业成绩几乎无影响。推荐：① 1-3 年级每天 <20 分钟；② 4-5 年级 20-40 分钟；③ 6 年级以上 60-90 分钟。关键：固定作业时间 + 安静的固定场所 + 不在孩子做作业时纠错。",
		evidence: "systematic_review",
		references: [
			{
				org: "AAP",
	...
	},
	{
		...
		question: "青少年睡眠不足怎么办？",
		answer:
			"13-18 岁推荐 8-10 小时/天，但 80%+ 青少年睡眠不足。原因：① 生理时钟后移（昼夜节律延迟）；② 屏幕蓝光抑制褪黑素；③ 学业压力。处理：固定作息、晚 9 点后无屏幕、卧室不放电子设备、必要时晨光疗法。",
		evidence: "cohort",
		references: [
			{ org: "AAP", title: "Sleep in Adolescents", year: 2023 },
		],
	},
	{
		...
		answer:
			"识别信号：回避社交/学校、睡眠问题、躯体不适（头痛/胃痛）、易怒、成绩突然下降。干预阶梯：① 学校心理咨询；② 家庭医生筛查；③ 儿童青少年精神科评估；④ 认知行为治疗 (CBT) 是首选（一线证据：response rate 60%+）；⑤ 严重时联合用药（SSRI）。",
		evidence: "systematic_review",
		references: [
			{ org: "AAP", title: "Anxiety in Teens", year: 2023 },
		],
	},
	{
		...
		question: "青少年抑郁的早期信号？",
		answer:
			"2 周以上持续：① 情绪低落、易怒、哭泣；② 兴趣丧失（包括曾喜欢的活动）；③ 睡眠/食欲明显变化；④ 自我评价低、无价值感；⑤ 学业/社交退缩。任一情况应：① 不忽视\"只是青春期的说法\"；② 立即联系儿童精神科；③ 筛查自杀想法（直接问不会增加风险，反而降低）。",
		evidence: "expert_opinion",
		references: [
	...
	},
	{
		...
		answer:
			"建议：① 先听孩子描述，不轻视；② 邀请 1 个同学到家里玩（人数少易建立连接）；③ 培养共同兴趣（运动、音乐、编程）；④ 角色扮演社交场景；⑤ 关注是否被欺凌（不只是没朋友）；⑥ 6 个月持续孤立 + 情绪低落，建议学校心理咨询或儿童精神科。",
		evidence: "expert_opinion",
		references: [
			{ org: "AAP", title: "Friendship in School-Age Children", year: 2022 },
		],
	},
];
